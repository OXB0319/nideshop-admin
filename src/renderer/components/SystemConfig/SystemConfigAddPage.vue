            ...
            <div class="form-table-box">
                <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
                    <el-form-item label="键" prop="key">
                        <el-input v-model="infoForm.key" :disabled="true"></el-input>
                    </el-form-item>
                    <el-form-item label="值" prop="value">
                        <el-input type="textarea" v-model="infoForm.value" :rows="3"></el-input>
        ...
        methods: {
            ...
            onSubmitInfo() {
                this.$refs['infoForm'].validate((valid) => {
                    if (valid) {
                        this.axios.post('systemConfig/store', this.infoForm).then((response) => {
            ...
            getInfo() {
                ...
                //加载详情
                let that = this
                this.axios.get('systemConfig/info', {
                    params: {
                        id: that.infoForm.id
                    }
                }).then((response) => {
